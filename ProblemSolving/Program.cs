...
namespace ProblemSolving
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region Assuit Sheet
            //Console.WriteLine(Multiples(12,5));
            //Console.WriteLine(GetCordsQuarter(-12,5));
            #endregion
        ...
        {
            //1- spilit the sentence with ' ' seperator 
            string[] words = sentence.Split(' ');
            //2- check for the length of every word 
            StringBuilder sb = new StringBuilder();
        ...
        #region Assuit Sheet
        public static string Multiples(int x,int y)
        {
            if (x % y == 0 || y % x == 0)
                return "Multiples";
            else
        ...
        public static string GetCordsQuarter(int x , int y)
        {
            if (x >= 0 && y >= 0)
                return "Q1";
            else if (x >= 0 && y < 0)
